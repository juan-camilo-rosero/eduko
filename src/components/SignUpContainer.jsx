...
function SignUpContainer() {
  ...
  const { userEmail, setUserEmail, createUser } = useContext(UserContext)
  ...
  return (
    <div className={`fixed h-screen bg-blue-darker w-full left-0 border-t-4 border-blue-turquoise z-40 flex flex-col items-center pt-32 px-6 gap-8 overflow-y-scroll pb-12 transition-all md:px-16 lg:px-24 lg:pt-28 ${(signUp)
        ...
        <input type="text" placeholder="profile photo url (optional)" className="w-4/5 py-2 bg-transparent border-b-2 border-blue-turquoise text-light outline-none text-xl md:w-1/2 lg:w-1/4" onChange={e => {
