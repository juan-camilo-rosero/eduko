    ...
    <section className='bg-[#0B0037]'>
      <div className="relative w-full h-screen">
        <div className='h-3/5 w-full flex flex-col items-center lg:items-start lg:pl-40 gap-12 pt-[12vh] lg:w-1/2 lg:absolute lg:left-0  lg:h-[90vh] lg:mt-[10vh] lg:gap-10'>
          <h1 className='text-4xl text-gray-100 font-bold w-3/4 text-center md:text-5xl lg:text-left lg:w-full'>Título - título título - título</h1>
          <p className='text-xl text-gray-100 text-center w-3/4 md:text-2xl lg:text-left lg:w-full z-10'>Automate the creation and grading of assignments. Write the topic, some recommendations, and Eduku will do the rest.</p>
