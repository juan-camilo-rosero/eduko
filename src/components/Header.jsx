...
function Header() {
  ...
  return (
    <header className="w-full bg-blue-dark px-6 flex justify-between items-center fixed t-0 h-16 lg:px-24 md:px-16 z-50">
        ...
        {(heroSection)
          ? <button className="py-2 px-8 bg-blue-turquoise rounded-xl font-semibold text-blue-dark hover:bg-blue-turquoiseHover transition-all lg:text-xl">Login</button>
          : <UserScore/>
        }
