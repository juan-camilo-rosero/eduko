...
function Alert() {
  ...
  return (
    <div className={`${(alertDiv) ? "flex" : "hidden"} transition-all w-screen h-screen fixed bg-black top-0 left-0 flex justify-center items-center bg-opacity-75 z-20`}>
      <div className={`flex w-[80vw] h-[45vh] bg-blue-dark t-0 rounded-xl items-center flex-col justify-between md:w-[50vw] md:h-auto lg:w-[23vw] lg:mt-16`}>
